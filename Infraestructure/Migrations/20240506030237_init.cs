        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobOfferModeId = table.Column<int>(type: "int", nullable: false),
                    PublicationDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 5, 6, 0, 2, 36, 304, DateTimeKind.Local).AddTicks(8440)),
                    CityId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 6, "Atención al Cliente, Call Center y Telemarketing" },
                    { 7, "Recursos Humanos y Capacitación" },
                    { 8, "Salud, Medicina y Farmacia" },
                    { 9, "Tecnología, Sistemas y Telecomunicaciones" },
                    { 10, "Marketing y Publicidad" },
                    { 11, "Producción y Manufactura" },
                    { 12, "Ingenierías" },
                    { 13, "Secretarias y Recepción" },
                    { 14, "Legales" },
                    { 15, "Aduana y Comercio Exterior" },
                    { 16, "Ingeniería Civil y Construcción" },
                    { 17, "Diseño" },
                    { 18, "Seguros" },
                    { 19, "Gerencia y Dirección General" },
                    { 20, "Comunicación, Relaciones Institucionales y Públicas" },
