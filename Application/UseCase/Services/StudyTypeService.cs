...
{
    public abstract class StudyTypeService<Request, Response, T> : IService<Request, Response> where Request : class where Response : class where T : class
    {
        protected readonly IRepository<T> _repository;
        protected readonly IMapper _mapper;
        public Parameters parameters;

        public StudyTypeService(IRepository<T> repository, IMapper mapper)
        {
